...
| Regional deformation support / lithosphere inheritance | Potentially very high; targets tableland grammar without painting terrain | Very high across collision, rifting, terrain, water barriers, geology and later worlds | Medium; corrected boundary work and a responsive surface path exist, but generated time-varying support does not and the reviewed belt has no named inherited contact | **One reduced-kinematic fixed-budget mechanism slice selected; inheritance remains conditional and budget-neutral** |
