...
Implementation checkpoint: the first seed-`12345` packet now renders matched
Globe, Unified Map and mechanically derived river-mouth views from one world and
