...
Research notes contain external findings, consultations or exploratory
reasoning. They are not repository truth until claims are verified and
synthesized into canonical architecture, system assessments, the experiment
registry or roadmap.
...
- [Landform O0a relationship-probe contract](landform-object-packet-o0-2026-07-15.md)
  — implemented and evaluated bounded common relationship evidence over S0 and D0: exact
...
- [Linked orogen shared-input manifest V0](orogen-linked-shared-input-v0-2026-07-15.md)
  — accepted exact input identity for the 8/4/2 km linked case: mesh and
