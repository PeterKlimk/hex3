...
| RDS0 | Finite growth, overlap/linkage, retirement and cross-front movement are the missing intermediate consequences between corrected work and erosion | One seed `8675309`, episode `9`, ordinary fine mesh; identical corrected parent work, finite-age envelope, response and fixed Legacy-derived terrain budget | Proposed in `regional-deformation-support.md`; not implemented. One reduced-kinematic mechanism counterfactual selected before any generated-history prior, parameter ladder or multi-seed campaign |
