...
| RDS0 | Finite growth, overlap/linkage, retirement and cross-front movement are the missing intermediate consequences between corrected work and erosion | RDS0a source plus RDS0b: seed `8675309`, episode `9`, 100k coarse source, ordinary ~250k process mesh, one exact-overlap map, identical continuous four-block Legacy budget, matched physical/Authentic terrain | RDS0a source pass retained. RDS0b rejected categorical center-owner transfer, then closed 2,877 donors through 83,559 exact overlap pairs (max coverage error `1.21e-7`); all fine work ledgers close within `5.8e-9 km²/Myr`, injected budgets match, and 56.6% of support drainage receivers change. Provisional narrow terrain pass: real linked lobes/lows/ends, but possible perforated/bead grammar and surviving roof. Await human review plus one exact relationship readout; no promotion, generated prior or sweep |
