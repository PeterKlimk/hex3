...
# Historical mountain roadmap / idea inventory

Archived during the July 2026 documentation rebuild. This is a chronological
terrain-work record, not the current project roadmap. Current status and
priorities live in [`../roadmap.md`](../roadmap.md) and the
